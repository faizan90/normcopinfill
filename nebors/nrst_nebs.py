...
current_process().authkey = b'all_workers_have_the_same_key'
...
#         self.in_var_df = self.in_var_df.copy()
    ...
    def get_nrst_stns(self):
        ...
        _drop_stns = self.in_var_df.columns.difference(self.nrst_stns_list)
    ...
    def plot_nrst_stns(self):
        ...
        _plt_ftn = NrstStns._plot_nrst_stns
