...
class CompareInfill:
    ...
    def _plot_infill_vs_obs_cdf_time_sers(
            self,
            infill_probs,
            orig_probs,
            alpha,
    ...
    def _plot_obs_vs_infill_vals_hist(
            self,
            orig_vals,
            infill_vals,
            n_vals,
    ...
    def _compar_ser(
        ...
        self._plot_obs_vs_infill_dists(
            out_add_info_df,
            summ_df,
            alpha,
            lw,
        ...
        if not self.update_summary_df_only:
            self._plot_obs_vs_infill_vals_hist(
                orig_vals,
                infill_vals,
                n_vals,
                out_compar_plot_loc)
    ...
    def plot_all(self, args):
        ...
        interp_data_idxs = logical_or(
            isnan(act_var),
            isnan(
                out_conf_df[self.fin_conf_head].loc[self.infill_dates].values))
